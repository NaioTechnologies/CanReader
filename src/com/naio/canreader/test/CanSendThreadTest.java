...
public class CanSendThreadTest extends
	...
	public void testExecuteCommand() {
		...
		if (response != null) {
			assertEquals("Execute a sudo command impossible",
					response.contains("device"), true);
		} else {
			assertEquals("Execute a sudo command impossible",true, false);
		}
